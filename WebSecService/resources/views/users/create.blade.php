                    ...
                    <form method="POST" action="{{ url('/users') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('security_question') is-invalid @enderror" 
                                ...
                                <option value="ما هو اسم أول مدرسة التحقت بها؟" {{ old('security_question') == 'ما هو اسم أول مدرسة التحقت بها؟' ? 'selected' : '' }}>
                                    ما هو اسم أول مدرسة التحقت بها؟
                                </option>
                                <option value="ما هو اسم أول حي سكنت فيه؟" {{ old('security_question') == 'ما هو اسم أول حي سكنت فيه؟' ? 'selected' : '' }}>
                                    ما هو اسم أول حي سكنت فيه؟
                                </option>
                                <option value="ما هو اسم أول حيوان أليف امتلكته؟" {{ old('security_question') == 'ما هو اسم أول حيوان أليف امتلكته؟' ? 'selected' : '' }}>
                                    ما هو اسم أول حيوان أليف امتلكته؟
                                </option>
                                <option value="ما هو اسم أول مدينة زرتها؟" {{ old('security_question') == 'ما هو اسم أول مدينة زرتها؟' ? 'selected' : '' }}>
                                    ما هو اسم أول مدينة زرتها؟
                                </option>
                                <option value="ما هو اسم أول كتاب قرأته؟" {{ old('security_question') == 'ما هو اسم أول كتاب قرأته؟' ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('security_answer') is-invalid @enderror" 
                                   id="security_answer" name="security_answer" value="{{ old('security_answer') }}" required>
                            @error('security_answer')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">ستحتاج هذه الإجابة لاستعادة كلمة المرور في المستقبل</div>
                        </div>
